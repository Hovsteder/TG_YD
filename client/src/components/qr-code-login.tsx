    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <Card className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
        <div className="flex justify-between items-center mb-6">
          <h3 className="font-medium text-lg">Log in to Telegram by QR Code</h3>
          <button 
        ...
        <div className="text-center">
          <ol className="list-decimal list-inside text-left mb-6 text-sm text-gray-600">
            <li className="mb-2">Open Telegram on your phone</li>
            <li className="mb-2">Go to <strong>Settings</strong> &gt; <strong>Devices</strong> &gt; <strong>Link Desktop Device</strong></li>
            <li className="mb-2">Point your phone at this screen to scan the QR code</li>
          </ol>
          ...
          <p className="text-sm text-gray-500 mb-6">
            {loading ? 'Generating QR Code...' : `QR code expires in ${remainingTime} seconds`}
          </p>
